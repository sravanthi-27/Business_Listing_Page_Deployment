...
            <p><span className="text-[#4D4D4D] font-montserrat text-[16px] font-semibold underline decoration-solid underline-offset-4 mb-4">
             ...
             <span className="text-[#4D4D4D] font-montserrat text-[16px] font-semibold"> / </span>
             <span className="text-[#4D4D4D] font-montserrat text-[16px] font-semibold underline decoration-solid underline-offset-4">
               Yoga
             </span>
            </p>
...
          <p className="text-[#4D4D4D] font-montserrat text-base font-normal font-400 leading-[140%] mb-4">
...
      <div className="hidden lg:block xl:hidden relative mt-8 mx-auto w-full px-2 pt-[50px]">
      <div className="flex w-full items-start gap-8">
          {/* Image container */}
          <div className="w-[320px] min-w-[280px] h-auto aspect-square rounded-[20px] border border-[#888] overflow-hidden">
            <div className="relative w-full h-full">
              {slides.map((slide, index) => (
...
            </h1>
            <p>
              <span className="text-[#4D4D4D] font-montserrat text-sm font-semibold underline decoration-solid underline-offset-3 mb-3">Fitness &amp; Body Movement</span> 
...
      <div className="hidden md:flex lg:hidden flex-col items-center w-full pt-[50px]">
        <div className="flex flex-col md:flex-row w-full items-start gap-8 pt-[20px]">
...
            </h1>
            <p>
            <span className="text-[#4D4D4D] font-montserrat text-sm font-semibold underline underline-offset-2 mb-3">Fitness &amp; Body Movement</span>
            <span className="text-[#4D4D4D] font-montserrat text-sm font-semibold mb-3"> / </span>
            <span className="text-[#4D4D4D] font-montserrat text-sm font-semibold underline underline-offset-2 mb-3">Yoga</span>
            </p>
            <div className="flex items-start gap-2 mb-4">
...
          </h1>
          <p>
          <span className="text-[#4D4D4D] font-montserrat text-[12px] font-semibold underline underline-offset-2 mb-3">Fitness &amp; Body Movement</span>
